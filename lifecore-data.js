...
export const STATIONS = [
  { id: 'email',    name: 'Email_HQ',    dot: 'ok',   badge: '3' },
  { id: 'appdev',   name: 'App_Dev',     dot: 'warn', badge: '1 blokkoló', domainId: 'work' },
  { id: 'finance',  name: 'Pénzügyek',   dot: 'warn', badge: 'júl. 5.', domainId: 'finance' },
  { id: 'health',   name: 'Egészség',    dot: 'crit', badge: 'alvás!', domainId: 'body' },
  { id: 'admin',    name: 'Admin',       dot: 'ok',   badge: '', domainId: 'command' },
  { id: 'social',   name: 'Kapcsolatok', dot: 'info', badge: '2', domainId: 'social' },
  { id: 'learning', name: 'Tanulás & AI', dot: 'warn', badge: '1/3', domainId: 'learning' },
  { id: 'rest',     name: 'Pihenés',     dot: 'crit', badge: '0 blokk', domainId: 'rest' },
  { id: 'loviverse', name: 'Loviverse',  dot: 'ok',   badge: '' },
];
